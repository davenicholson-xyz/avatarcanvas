...
type ClipOptions = "circle" | "triangle" | "diamond" | [number, number][]
  ...
  private canvasEvents(): void {
    ...
    this.canvas.addEventListener("mousemove", (e: MouseEvent): void => {
      ...
      this.emit("mousemove", {
        ...
        canvas: this.mouseOnCanvas,
        image: this.mouseOnImage,
    ...
    this.canvas.addEventListener("wheel", (e: WheelEvent): void => {
      ...
      if (this.canZoom && this.canScroll) {
        ...
        this.emit("scaled", {
          wheel: true,
          scale: this.scale,
          modifier: this.scaleModifier,
          absolute: this.scale * this.scaleModifier,
          origin: this.imageOrigin,
        })
      }
    })
